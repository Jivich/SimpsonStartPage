...
StartPage.prototype.imgRandom = function() {
  ...
  if (nRandom == 1) {
    ...
    var imagen = "Images/card/homero_0";
    for (var i = 0; i <= 5; i++) {
      document.getElementById("imgGrid" + arrayIMG[i]).src = imagen + (i + 1) + ".jpg";
    }
  } else if (nRandom == 2) {
    document.getElementsByTagName("BODY")[0].style.background = "#730f17";
    var imagen = "Images/card/magios_0";
    for (var i = 0; i <= 5; i++) {
      document.getElementById("imgGrid" + arrayIMG[i]).src = imagen + (i + 1) + ".jpg";
    }
  } else if (nRandom == 3) {
    document.getElementsByTagName("BODY")[0].style.background = "#203765";
    var imagen = "Images/card/simpson_0";
    for (var i = 0; i <= 5; i++) {
      document.getElementById("imgGrid" + arrayIMG[i]).src = imagen + (i + 1) + ".jpg";
    }
  }
